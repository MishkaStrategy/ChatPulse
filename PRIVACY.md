...
- индивидуальные профили чатов: собственная команда/интервал/стоп-фраза, лимит продолжений, лимит времени и настройка Telegram-событий;
...
ChatPulse 0.6.0 экспортирует только **портативную конфигурацию**, а не полную копию локального хранилища. JSON содержит общие настройки, URL/названия чатов, их включённое состояние и профили.
